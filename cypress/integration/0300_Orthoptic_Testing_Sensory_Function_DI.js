...
describe('0300_Sensory_Function_Element_DI', () => {

    //Add the Sensory Function element
    it('0300.1_To_Add_Sensory_Function_Element' , () => {
      cy.get("#js-manage-elements-btn").should('be.visible').click()

      cy.get('body').then((body) => {
    
          if (body.find('#manage-elements-Sensory-Function[class="added"]').length == 0)
          {
    ...
    it('0300.2_To_Validate_Convergence_Accommodation_Section_isAvailable' , () => {
    ...
    it('0300.4_To_Add_And_Verify_Details' , () => {

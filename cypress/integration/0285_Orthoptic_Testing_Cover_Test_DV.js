...
describe('0285_Cover_Test_Element_DV', () => {

  it('0285.9_Validate_Cover_Test_Element_Header' , () => {
  ...
  it('0285.10_Validate_Cover_Test_Element_Data_Distance_Correction_CHP_Comments_Prism1_Value1' , () => {
  ...
  it('0285.11_Validate_Cover_Test_Element_Data_Prism001_Prism2_Value2' , () => {
  ...
  it('0285.12_Validate_Cover_Test_Element_Data_Prism002' , () => {
  ...
  it('0285.13_Validate_Element_Data_Cover_Test_Comments' , () => {

...
describe('0080_IOP_History_Element_DI', () => {

    //Add the IOP History element
    it('0080.1_To_Add_IOP_History_Element' , () => {
    ...
    it('0080.2_To_Validate_IOP_History_isAvailable' , () => {
    ...
    it('0080.3_To_Add_And_Verify_Details_For_Right_Eye' , () => {
    ...
    it('0080.4_To_Add_Date_For_Right_Eye' , () => {
    ...
    it('0080.5_To_Add_Comments_For_Right_Eye' , () => {
    ...
    //Add and verify the IOP History details and values, for left eye
      it('0080.6_To_Add_And_Verify_Details_For_Left_Eye' , () => {
    ...
    it('0080.7_To_Add_Date_For_Left_Eye' , () => {
    ...
    //Add IOP History comment, for left eye
      it('0080.8_To_Add_Comments_For_Left_Eye' , () => {

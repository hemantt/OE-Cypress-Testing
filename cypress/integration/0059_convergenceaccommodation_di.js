...
describe('0059_Convergence_Accommodation_Element_DI', () => {

    //Add the Convergence & Accommodation element
    it('0059.1_To_Add_Convergence_Accommodation_Element' , () => {
    ...
    it('0059.2_To_Validate_Convergence_Accommodation_Section_isAvailable' , () => {
    ...
    it('0059.4_To_Add_And_Verify_Details' , () => {
    ...
    //To add description
    it('0059.5_To_Add_and_Verify_Description' , () => {
        cy.fixture("orthoptictesting.json").then((orthoptictesting) => {

...
describe('0505_Operation Booking Event', () => {

  //Test to check and click the Add Event button
  it('0505.1_Check_Add_Event_Button_And_Click', () => { 
  ...
  it('0505.2_Check_Operation_Booking_Link_And_Click', () => { 
  ...
  it('0505.3_Check_Add_Operation_Booking_Page_Loaded_Successfully', () => { 
  ...
  it('0505.4_Check_Diagnosis_Options', () => { 
  ...
  //Test to verify that the Diagnosis is selected and then well-populated with the value selected
  it('0505.5_Check_Diagnosis', () => { 

    cy.get("#add-operation-booking-diagnosis").should('be.visible').click()

    //Select the Diagnosis value as specified in the operationbooking json for Diagnosis
    cy.fixture("operationbooking.json").then((operationbooking) => {
      cy.get(".add-options").eq(0).contains(operationbooking.Diagnosis).parent().click()
    })
    
    //Click the (+Click to add) button
    cy.get(".add-icon-btn").eq(0).should('be.visible').click()
  ...
  it('0505.6_Check_And_Select_Procedure', () => { 
  ...
  it('0505.7_Check_And_Select_Eye_For_Operation', () => { 
    cy.fixture("operationbooking.json").then((operationbooking) => {
  ...
  it('0505.8_Check_And_Select_Complexity', () => { 
    cy.fixture("operationbooking.json").then((operationbooking) => {
  ...
  it('0505.9_Check_And_Select_Anaesthetic_Type', () => { 
      cy.fixture("operationbooking.json").then((operationbooking) => {
  ...
  it('0505.10_Check_And_Select_Anaesthetic_Choice', () => { 
    cy.fixture("operationbooking.json").then((operationbooking) => {
  ...
  it('0505.11_Check_And_Choose_Patient_Needs_To_Stop_Medication', () => { 
    cy.fixture("operationbooking.json").then((operationbooking) => {
  ...
  it('0505.12_Check_And_Choose_Schedule_Option', () => { 
    cy.fixture("operationbooking.json").then((operationbooking) => {
...
//Test to ensure that doctor organising admission, gets the value from the operationbooking json file
  it('0505.13_Check_And_Input_Doctor_Organising_Admission', () => { 
  ...
  it('0505.14_Verify_Doctor_Organising_Admission_Populated_Correctly', () => { 
  ...
  it('0505.15_Verify_And_Add_Pre_Assessment_Type', () => { 

    cy.fixture("operationbooking.json").then((operationbooking) => {

      //Check the value that gets populated in the read-only field
      cy.get('#Element_OphTrOperationbooking_PreAssessment_type_id_1').scrollIntoView().should('be.visible')
      cy.get("#Element_OphTrOperationbooking_PreAssessment_type_id_1").should('be.visible').click()
    })
  ...
  it('0505.16_Click_Save_And_Schedule_Now_And_Verify_The_Successful_Save', () => { 
  ...
  it('0505.17_Check_And_Select_Context_Change', () => { 
    cy.fixture("operationbooking.json").then((operationbooking) => {
  ...
  it('0505.18_Verify_Session_Date_And_Click_At_A_Session', () => { 
  ...
  it('0505.19_Check_And_Select_Theatre_Time', () => { 
  ...
  it('0505.20_Check_And_Verify_Operation_Comments', () => { 
  ...
  it('0505.21_Check_And_Verify_Session_Comments', () => { 
  ...
  it('0505.22_Check_And_Verify_RTT_Comments', () => { 
  ...
  it('0505.23_OperationBookingEvent', () => { 
  ...
  //Test to check and click the Confirm slot button, and verify that the next page get loaded successfully
  it('0505.24_OperationBookingEvent', () => { 
  ...
  it('0505.26_Verify_Operation_Eye', () => { 
      cy.fixture("operationbooking.json").then((operationbooking) => {
  ...
  it('0505.27_Verify_Complexity', () => { 
            cy.fixture("operationbooking.json").then((operationbooking) => {
          cy.get(".data-value").eq(0).should('be.visible').should('contain',operationbooking.Complexity)
        })
  })

  //Verify the value of Anaesthetic Type
  it('0505.28_Verify_Anaesthetic_Type', () => { 
    
        cy.fixture("operationbooking.json").then((operationbooking) => {
          cy.get(".data-value").eq(2).should('be.visible').should('contain',operationbooking.Anaesthetic_type)
        })

  })

  //Verify the value of Anaesthetic Choice
  it('0505.29_Verify_Anaesthetic_Choice', () => { 
            cy.fixture("operationbooking.json").then((operationbooking) => {
          cy.get(".data-value").eq(3).should('be.visible').should('contain',operationbooking.Anaesthetic_choice)
        })

  })

  //Verify the value of Patient Needs To Stop Medication
  it('0505.30_Verify_Patient_Needs_To_Stop_Medication', () => { 
            cy.fixture("operationbooking.json").then((operationbooking) => {
          cy.get(".data-value").eq(4).should('be.visible').should('contain',operationbooking.Patient_needs_to_stop_medication)
        })

  })

  //Verify the value of Doctor Organising Admission
  it('0505.31_Verify_Doctor_Organising_Admission', () => { 
  ...
  it('0505.32_Verify_Schedule_Option', () => { 
            cy.fixture("operationbooking.json").then((operationbooking) => {

...
describe('0305_Prism_Reflex_Test_Element_DI', () => {

    //Add the Prism Reflex Test element
    it('0305.1_To_Add_Prism_Reflex_Test_Element' , () => {
      cy.get("#js-manage-elements-btn").should('be.visible').click()

      cy.get('body').then((body) => {
    
          if (body.find('#manage-elements-Prism-Reflex-Test[class="added"]').length == 0)
          {
    ...
    it('0305.2_To_Validate_Prism_Reflex_Test_Section_isAvailable' , () => {
    ...
    it('0305.4_To_Add_And_Verify_Details' , () => {
    ...
    //To add comments
    it('0305.5_To_Add_and_Verify_Comments' , () => {

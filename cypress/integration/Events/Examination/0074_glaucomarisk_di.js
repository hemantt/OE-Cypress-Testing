...
describe('0074_Glaucoma_Risk_Element_DI', () => {

    //Add the Glaucoma Risk element
    it('0074.1_To_Add_Glaucoma_Risk_Element' , () => {
    ...
    it('0074.2_To_Validate_Glaucoma_Risk_Section_isAvailable' , () => {
    ...
    it('0074.3_To_Add_And_Verify_Details' , () => {
    ...
    it('0074.4_Validate_Popup_Links' , () => {

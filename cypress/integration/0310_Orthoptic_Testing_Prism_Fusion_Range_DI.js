...
describe('0310_Prism_Fusion_Range_Element_DI', () => {

    //Add the Prism Fusion Range element
    it('0310.1_To_Add_Prism_Reflex_Test_Element' , () => {
      cy.get("#js-manage-elements-btn").should('be.visible').click()

      cy.get('body').then((body) => {
    
          if (body.find('#manage-elements-Prism-Fusion-Range[class="added"]').length == 0)
          {
    ...
    it('0310.2_To_Validate_Prism_Fusion_Range_Section_isAvailable' , () => {
    ...
    it('0310.4_To_Add_And_Verify_Details' , () => {
    ...
    it('0310.6_To_Add_Distance_Values' , () => {
        cy.fixture("AddExaminationEvents_Orthoptic_Testing.json").then((orthoptictesting) => {
    ...
    //To add comments
    it('0310.7_To_Add_and_Verify_Comments' , () => {

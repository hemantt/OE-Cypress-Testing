...
describe('0315_Stereoacuity_Element_DI', () => {

    //Add the Stereoacuity element
    it('0315.1_To_Add_Stereoacuity_Element' , () => {
      cy.get("#js-manage-elements-btn").should('be.visible').click()

      cy.get('body').then((body) => {
    
          if (body.find('#manage-elements-Stereoacuity[class="added"]').length == 0)
          {
    ...
    it('0315.2_To_Validate_Stereoacuity_Section_isAvailable' , () => {
    ...
    it('0315.4_To_Add_And_Verify_Details' , () => {

...
describe('0360_Laser_Management_DI', () => {

    //Add the Laser Management 
    it('0360.1_To_Add_Laser_Management' , () => {
      cy.get("#js-manage-elements-btn").should('be.visible').click()

      cy.get('body').then((body) => {
    
          if (body.find('#manage-elements-Laser-Management[class="added"]').length == 0)
          {
    ...
    it('0360.2_To_Validate_Laser_Management_SectionisAvailable' , () => {
    ...
    it('0360.4_To_Add_Details' , () => {
      ...
      .select(clinicalmanagement.Laser_Management_Status_Right_Eye)
      }
      ...
      if (clinicalmanagement.Laser_Management_Status_Right_Eye=="Deferred")
      {
        ...
        .select(clinicalmanagement.Laser_Management_Deferral_Reason_Right_Eye)
          ...
          if (clinicalmanagement.Laser_Management_Deferral_Reason_Right_Eye=="Other")
          {
            ...
            .clear().type(clinicalmanagement.Laser_Management_Deferral_Reason_Other_Right_Eye)
          }
      }
      ...
      if (clinicalmanagement.Laser_Management_Status_Right_Eye=="Booked for a future date")
      {
        ...
        .select(clinicalmanagement.Laser_Management_Type_Right_Eye)
          ...
          if (clinicalmanagement.Laser_Management_Type_Right_Eye=="Other")
          {
            ...
            .clear().type(clinicalmanagement.Laser_Management_Type_Name_Right_Eye)
          }

          cy.get('#OEModule_OphCiExamination_models_Element_OphCiExamination_LaserManagement_right_comments')
          .clear().type(clinicalmanagement.Laser_Management_Comments_Right_Eye)
      }

      // Case - When "Performed today" is chosen
      if (clinicalmanagement.Laser_Management_Status_Right_Eye=="Performed today")
      {
      ...
      .select(clinicalmanagement.Laser_Management_Status_Left_Eye)
      ...
      if (clinicalmanagement.Laser_Management_Status_Left_Eye=="Deferred")
      {
        ...
        .select(clinicalmanagement.Laser_Management_Deferral_Reason_Left_Eye)
        ...
        if (clinicalmanagement.Laser_Management_Deferral_Reason_Left_Eye=="Other")
        {
          ...
          .clear().type(clinicalmanagement.Laser_Management_Deferral_Reason_Other_Left_Eye)
        }
      }
      ...
      if (clinicalmanagement.Laser_Management_Status_Left_Eye=="Booked for a future date")
      {
        ...
        .select(clinicalmanagement.Laser_Management_Type_Left_Eye)
         ...
         // Case - When "Booked for a future date" is chosen and Laser Type Chosen is "Other"
          if (clinicalmanagement.Laser_Management_Type_Left_Eye=="Other")
          {
            ...
            .clear().type(clinicalmanagement.Laser_Management_Type_Name_Left_Eye)
          }

        cy.get('#OEModule_OphCiExamination_models_Element_OphCiExamination_LaserManagement_left_comments')
        .clear().type(clinicalmanagement.Laser_Management_Comments_Left_Eye)
      }



      // Case - When "Performed today" is chosen
      if (clinicalmanagement.Laser_Management_Status_Left_Eye=="Performed today")
      {

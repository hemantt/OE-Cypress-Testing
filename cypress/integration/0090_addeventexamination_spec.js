  ...
  it('060.25_Add_And_Verify_History', () => { 
    ...
    it('060.31_Add And Verify CVI Status', () => { 
        ...
        cy.get('body').then(($body) => {
            ...
            if ($body.find('#OEModule_OphCiExamination_models_Element_OphCiExamination_CVI_Status_text').text().trim() == "Unknown"){
...
//Validate Drops
    ...
    it('060.60_Validate Anterior Segment', () => { 
        ...
        cy.fixture("addexaminationevent.json").then((addexaminationevent) => {
            ...
            //Scroll to the Anterior Segment Right Eye Comments
            cy.get(".data-value").eq(16).scrollIntoView().should('be.visible')
            //Anterior Segment comments (Right Eye) to be verified against the data in the addexaminationevent json file
            cy.get(".data-value").eq(16).should('be.visible').contains(addexaminationevent.Anterior_Segment_Right_Comments)

            //Scroll to the Anterior Segment Left Eye Comments
            cy.get(".data-value").eq(20).scrollIntoView().should('be.visible')
            //Anterior Segment comments (Left Eye) to be verified against the data in the addexaminationevent json file

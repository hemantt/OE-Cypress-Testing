...
describe('0207.1_Anterior_Segment_CCT_DI', () => {

    //Add the Anterior_Segment_CCT element
    it('0207.1_To_Anterior_Segment_CCT' , () => {
    ...
    it('0207.2_To_Validate_Anterior_Segment_CCT_SectionisAvailable' , () => {

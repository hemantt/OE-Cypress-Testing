...
describe('0078_Intraocular_Pressure_Element_DI', () => {

    //Add the Cover Test element
    it('0078.1_To_Add_Intraocular_Pressure_Element' , () => {
    ...
    it('0078.2_To_Validate_Intraocular_Pressure_isAvailable' , () => {
    ...
    it('0078.3_To_Add_And_Verify_Details_For_Right_Eye' , () => {
    ...
    //Add and verify the Intraocular Pressure details and values, for left eye
      it('0078.4_To_Add_And_Verify_Details_For_Left_Eye' , () => {
      ...
      it('0078.5_To_Add_Comments_For_Right_Eye' , () => {
      ...
      it('0078.6_To_Add_Comments_For_Left_Eye' , () => {

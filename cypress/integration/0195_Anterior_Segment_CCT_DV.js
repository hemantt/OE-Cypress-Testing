...
describe('0195_Anterior_Segment_CCT_DV', () => {

  it('0195.5_Validate_Anterior_Segment_CCT_Element_Header' , () => {
    
    cy.get('[data-element-type-name="CCT"] > header > h3').should('be.visible').should('contain', 'CCT')
  
  })

  it('0195.6_Validate_CCT_Details_Right_Eye' , () => {
  ...
  it('0195.7_Validate_CCT_Details_Left_Eye' , () => {

...
describe('0285_Cover_Test_Element_DI', () => {

    //Add the Cover Test element
    it('0285.1_To_Add_Corrective_Head_Posture_Element' , () => {
      cy.get("#js-manage-elements-btn").should('be.visible').click()

      cy.get('body').then((body) => {
    
          if (body.find('#manage-elements-Cover-Test[class="added"]').length == 0)
          {
    ...
    it('0285.2_To_Validate_Corrective_Head_Posture_Section_isAvailable' , () => {
    ...
    it('0285.4_To_Add_And_Verify_Details' , () => {
    ...
    it('0285.5_To_Add_and_Verify_Short_Comments' , () => {
    ...
    it('0285.6_To_Add_and_Verify_Long_Comments' , () => {
  ...
  //Verify Edit button
    it('0285.7_To_Verify_Edit_Button' , () => {
